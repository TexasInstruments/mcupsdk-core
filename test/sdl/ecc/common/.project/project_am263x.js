...
const filedirs = {
    common: [
        ...
        "../../../../../dpl", /* SDL DPL base */
		"../../../../common",
		"../../../../ecc_sdl_funcTest/am263x-cc",/* SDL FT base */
		"../../../../ecc_sdl_unitTest/am263x-cc",/* SDL UT base */
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/test/sdl/ecc/ecc_sdl_funcTest/am263x-cc/",
	    "${MCU_PLUS_SDK_PATH}/test/sdl/ecc/ecc_sdl_unitTest/am263x-cc/",
    ],
};
