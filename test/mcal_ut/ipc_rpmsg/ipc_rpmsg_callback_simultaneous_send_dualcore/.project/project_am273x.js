...
const files = {
    common: [
        "ipc_rpmsg_callback_simultaneous_send_dualcore.c",  
        "main.c",
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ipc_rpmsg_callback_simultaneous_send_dualcore_main",
        },
    }
];
...
const systemProjects = [
    {
        name: "ipc_rpmsg_callback_simultaneous_send_dualcore",
        tag: "freertos_nortos",
...
function getComponentProperty() {
    ...
    property.name = "ipc_rpmsg_callback_simultaneous_send_dualcore";
