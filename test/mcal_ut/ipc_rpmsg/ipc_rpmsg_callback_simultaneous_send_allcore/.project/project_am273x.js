...
const files = {
    common: [
        "ipc_rpmsg_callback_simultaneous_send_allcore.c",  
        "main.c",
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ipc_rpmsg_callback_simultaneous_send_allcore_main",
        },
    }
];
...
const systemProjects = [
    {
        name: "ipc_rpmsg_callback_simultaneous_send_allcore",
        tag: "freertos_nortos",
...
function getComponentProperty() {
    ...
    property.name = "ipc_rpmsg_callback_simultaneous_send_allcore";
