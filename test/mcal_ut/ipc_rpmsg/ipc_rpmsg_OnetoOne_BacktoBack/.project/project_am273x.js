...
const files = {
    common: [
        "ipc_rpmsg_onetoone_backtoback.c", 
        "main.c",
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ipc_rpmsg_onetoone_backtoback_main",
        },
    }
];
...
const buildOptionCombos = [
    ...
    { device: device, cpu: "r5fss0-1", cgt: "ti-arm-clang", board: "am273x-evm", os: "freertos", isPartOfSystemProject: true},
    { device: device, cpu: "c66ss0", cgt: "ti-c6000", board: "am273x-evm", os: "freertos", isPartOfSystemProject: true},
];

const systemProjects = [
    {
        name: "ipc_rpmsg_OnetoOneBacktoBack",
        tag: "freertos",
...
function getComponentProperty() {
    ...
    property.name = "ipc_rpmsg_OnetoOneBacktoBack";
