...
const files = {
    common: [
        "ipc_rpmsg_any_to_any_r5f01_maincore.c",  
        "main.c",
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ipc_rpmsg_any_to_any_main",
        },
    }
];
...
const systemProjects = [
    {
        name: "ipc_rpmsg_any_to_any_r5fss01_maincore",
        tag: "freertos_nortos",
...
function getComponentProperty() {
    ...
    property.name = "ipc_rpmsg_any_to_any_r5fss01_maincore";
