...
const includes_r5f_mpu = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/kernel/freertos/config/am261x/r5f_mpu",
    ],
};
...
const libs_r5f_mpu = {
    common: [
        ...libs_r5f_common.common,
        "freertos.am261x.r5f-mpu.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
[
    {
        input: ".project/templates/am261x/freertos/main_freertos_mpu.c.xdt",
        output: "../main.c",
        options: {
            entryFunction: "test_freertos_main",
        },
...
const buildOptionCombos = [
    ...
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-som", os: "freertos_mpu"},
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am261x-lp", os: "freertos_mpu"},
];
