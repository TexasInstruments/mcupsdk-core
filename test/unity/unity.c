...
#else
const char PROGMEM UnityStrBegin[]                         = "Unit tests started ...";
const char PROGMEM UnityStrOk[]                            = "All tests have passed";
const char PROGMEM UnityStrFinalFail[]                     = "Some tests have failed";
...
static void UnityTestResultsBegin(const char* file, const UNITY_LINE_TYPE line)
{
    ...
    UnityPrintNumber((UNITY_INT)Unity.CurrentTestcaseId);
    UNITY_OUTPUT_CHAR(':');
#endif
#endif
#endif
...
void UnityDefaultTestRun(UnityTestFunction Func, const char* FuncName, const int FuncLineNum, unsigned int  TestcaseId, void *Args)
{
    Unity.CurrentTestName = FuncName;
    Unity.CurrentTestLineNumber = (UNITY_LINE_TYPE)FuncLineNum;
    Unity.CurrentTestcaseId = TestcaseId;
    Unity.CurrentTestArgs = Args;
    Unity.NumberOfTests++;
    UNITY_CLR_DETAILS();
