...
typedef void (*UnityTestFunction)(void *args);
...
struct UNITY_STORAGE_T
{
    ...
    unsigned int CurrentTestcaseId;
    void *CurrentTestArgs;
...
void UnityDefaultTestRun(UnityTestFunction Func, const char* FuncName, const int FuncLineNum, 
      unsigned int TestcaseId, void *Args);
#else
...
#ifndef RUN_TEST
#ifdef CMOCK
#define RUN_TEST(func, num, testcaseId, args) UnityDefaultTestRun(func, #func, num, testcaseId, args)
#else
#define RUN_TEST(func, testcaseId, args) UnityDefaultTestRun(func, #func, __LINE__, testcaseId, args)
#endif
#endif
