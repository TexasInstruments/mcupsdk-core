...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ECAP_SIGNAL_MONITORING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ecap_signal_monitoring_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "ecap_signal_monitoring";
    property.isInternal = true;
    property.description = "An ECAP PWM Monitoring example. This example monitors pwm."
