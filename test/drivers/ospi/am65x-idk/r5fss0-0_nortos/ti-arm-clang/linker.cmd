...
SECTIONS
{
    ...
    .globalScratchBuffer (NOLOAD) : {} > DDR_2
...
MEMORY
{
    R5F_VECS  : ORIGIN = 0x41C3E100 , LENGTH = 0x00000040
    R5F_TCMA  : ORIGIN = 0x00000000 , LENGTH = 0x00007FC0
    R5F_TCMB0 : ORIGIN = 0x41010000 , LENGTH = 0x00008000

    /* memory segment used to hold CPU specific non-cached data, MAKE to add a MPU entry to mark this as non-cached */
    NON_CACHE_MEM : ORIGIN = 0x41C70000 , LENGTH = 0x8000

    /* when using multi-core application's i.e more than one R5F/M4F active, make sure
     * this memory does not overlap with other R5F's
     */
    MSRAM     : ORIGIN = 0x70000000 , LENGTH = 0x80000
    ...
    DDR_2      (RWIX)      : ORIGIN = 0xA4000000 LENGTH = 0x02000000
}
