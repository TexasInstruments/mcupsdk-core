...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_mcspi_master_dma_main",
        },
    }
];
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_mcspi_slave_dma_main",
        },
    }
];

const buildOptionCombos = [
    { device: "am263x", cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am263x-cc", os: "freertos", isPartOfSystemProject: true},
    { device: "am263x", cpu: "r5fss0-1", cgt: "ti-arm-clang", board: "am263x-cc", os: "nortos", isPartOfSystemProject: true},
    { device: "am263x", cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am263x-lp", os: "freertos", isPartOfSystemProject: true},
    { device: "am263x", cpu: "r5fss0-1", cgt: "ti-arm-clang", board: "am263x-lp", os: "nortos", isPartOfSystemProject: true},
];

const systemProjects = [
    {
        name: "test_mcspi_master_slave_dma",
        tag: "freertos_nortos",
