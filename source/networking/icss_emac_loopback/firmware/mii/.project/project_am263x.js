...
const postBuildSteps_pru0 = [
    "$(CG_TOOL_ROOT)/bin/hexpru.exe ${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_loopback/firmware/mii/icss_emac_hexpru.cmd dual_emac_am263x-cc_icssm-pru0_fw_ti-pru-cgt.out;",
