...
let edma_rm_module = {
    ...
    config: [
        /*  attributes */
        {
            ...
            default: "ownDmaCh",
            options: [
                { name: "ownDmaCh",  displayName: "Own Dma Channel" },
                { name: "ownQdmaCh", displayName: "Own Qdma Channel" },
                { name: "ownTcc",    displayName: "Own Tcc" },
                { name: "ownParam",  displayName: "Own Param" },
