...
let gpmc_module = {
    ...
    config : [
        ...
        {
            name: "csRdOffTime",
            displayName: "Chip Select Read de-assertion time",
        ...
        {
            name: "csWrOffTime",
            displayName: "Chip Select Write de-assertion time",
        ...
        {
            name: "advRdOffTime",
            displayName: "ADV Read de-assertion time",
        ...
        {
            name: "advWrOffTime",
            displayName: "ADV Write de-assertion time",
        ...
        },
        {
            ...
            displayName: "ADV Assertion time in an AADMultiplexed access",
        ...
        },
        {
            ...
            displayName: "ADV Read de-assertion time in an AADMultiplexed access",
        ...
        },
        {
            ...
            displayName: "ADV Write de-assertion time in an AADMultiplexed access",
        ...
        {
            name: "weOffTime",
            displayName: "WE de-assertion time",
        ...
        {
            name: "oeOffTime",
            displayName: "OE de-assertion time",
            description: "De-assertion time in GPMC_FCLK cycles from start cycle time",
        ...
        {
            name: "oeAadMuxOnTime",
            displayName: "OE assertion time in an AADMultiplexed access",
        ...
        },
        {
            ...
            displayName: "OE de-assertion time in an AADMultiplexed access",
        ...
        },
        {
            ...
            displayName: "Cycle delay for different Chip Select",
