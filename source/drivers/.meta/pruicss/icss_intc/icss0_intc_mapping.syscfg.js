...
let icss_intc_mapping_top_module_name = "/drivers/pruicss/icss_intc/icss0_intc_mapping";

let icss_intc_mapping_top_module = {
    displayName: "ICSS0 INTC Internal Signals Mapping",
    ...
    defaultInstanceName: "CONFIG_ICSS0_INTC_MAPPING",
    ...
    config: [
        ...
        },
        {
            ...
            default: "16",
            options: soc.getEventConfigOptions('ICSSG0'),
