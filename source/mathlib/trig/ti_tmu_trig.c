...
float __attribute__((noinline, naked)) ti_tmu_sin_pu(float angleRad)
{
     __asm__ volatile(                                   \
        "   PUSH {r10}                            \n"    \
        "   MOV.W    r10, #0x60000                \n"    \
...
float __attribute__((noinline, naked)) ti_tmu_cos_pu(float angleRad)
{
...
float __attribute__((noinline, naked)) ti_tmu_atan_pu(float angleRad)
{
...
float __attribute__((noinline, naked)) ti_tmu_atan(float angleRad)
{
