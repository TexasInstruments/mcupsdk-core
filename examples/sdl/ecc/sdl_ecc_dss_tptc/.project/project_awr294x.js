...
const filedirs = {
    common: [
        ...
        "../../..", /* Example base */
        "../../../../../dpl", /* SDL DPL base */
		"../../../../../ecc/sdl_ecc_dss_tptc/awr294x-evm/",
    ],
};
...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_dss_tptc",
	    "${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_dss_tptc/awr294x-evm/",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_DSS_TPTC_ECC";
...
function getComponentProperty() {
    ...
    property.name = "sdl_dss_ecc_tptc";
    property.isInternal = false;
    property.description = "This example verifies ECC inject operations for DSS ECC TPTCs in single and double bits "
