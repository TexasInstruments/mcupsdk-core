...
function getmakefilePruPostBuildSteps(cpu, board)
{
    ...
    return  [
        "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=PRU0Firmware -o pru0_load_bin.h sdl_ecc_pru_scrubber_pru0_" + board + "_" + cpu + "_fw_ti-pru-cgt.out; $(MOVE) pru0_load_bin.h ${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_pru_scrubber/pru0_load_bin.h"
    ];
}
