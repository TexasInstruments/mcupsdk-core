...
const includes_freertos_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/sdl/include",
        "${MCU_PLUS_SDK_PATH}/source/sdl/esm/v2/v2_0",
        "${MCU_PLUS_SDK_PATH}/source/pru_io/driver",
		"${MCU_PLUS_SDK_PATH}/examples/sdl/dpl/",
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/",
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_pru_scrubber/am263px/sdl_ecc_pru_scrubber_r5f0/",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_ECC_PRU_SCRUBBER";
