...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_dss_l2_edc/",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_DSS_DSP_L2_EDC";
...
function getComponentProperty() {
    ...
    property.name = "sdl_dss_l2_edc_example";
    property.isInternal = false;
	property.description = "This example verifies EDC inject operations for DSS L2 memory in single and double bits"
