...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_dss_l3_ecc",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_DSS_L3_ECC";
...
function getComponentProperty() {
    ...
    property.name = "sdl_dss_ecc_l3_example";
    property.isInternal = false;
    property.description = "This example verifies ECC inject operations for DSS ECC AGGRs in single and double bits "
