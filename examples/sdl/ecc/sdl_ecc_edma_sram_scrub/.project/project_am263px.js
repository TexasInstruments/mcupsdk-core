...
const includes_nortos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/examples/sdl/",
        "${MCU_PLUS_SDK_PATH}/examples/sdl/ecc/sdl_ecc_edma_sram_scrub/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "sdl_ecc_edma_sram_scrub";
    property.isInternal = false;
    property.description = "This example verifies ECC inject operations in single and double bits for EDMA Scrub"
