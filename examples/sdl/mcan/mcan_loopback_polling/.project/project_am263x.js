...
const includes_freertos_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/examples/sdl/mcan/mcan_loopback_polling",
        "${MCU_PLUS_SDK_PATH}/examples/sdl/mcan/mcan_loopback_polling/sdl",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_MCAN+SDL";
