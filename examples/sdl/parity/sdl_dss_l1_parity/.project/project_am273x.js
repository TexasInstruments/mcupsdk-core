...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/parity/sdl_dss_l1_parity/",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_DSS_L1_PARITY";
...
function getComponentProperty() {
    ...
    property.name = "sdl_dss_l1_parity_example";
    property.isInternal = false;
	property.description = "This example verifies Parity inject operations for DSS L1 memory"
