...
const includes_nortos = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/examples/sdl/parity/sdl_dss_l2_parity/",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_SDL_DSS_L2_PARITY";
...
function getComponentProperty() {
    ...
    property.name = "sdl_dss_l2_parity_example";
    property.isInternal = false;
	property.description = "This example verifies DSS L2 memory parity"
