...
const readmeDoxygenPageTag = "EXAMPLES_AI_TORQUE_MEASUREMENT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "torque_measurement_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "torque_measurement";
    property.isInternal = false;
    property.description = "AI torque measurement example using feature extraction and neural network inference."
