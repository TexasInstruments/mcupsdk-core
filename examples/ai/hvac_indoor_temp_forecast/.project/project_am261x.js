...
const readmeDoxygenPageTag = "EXAMPLES_AI_HVAC_INDOOR_TEMP_FORECAST";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "hvac_indoor_temp_forecast_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "hvac_indoor_temp_forecast";
    property.isInternal = false;
    property.description = "AI HVAC indoor temperature forecasting example using feature extraction and neural network inference."
