...
const readmeDoxygenPageTag = "EXAMPLES_AI_BLOWER_IMBALANCE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "blower_imbalance_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "blower_imbalance";
    property.isInternal = false;
    property.description = "AI blower imbalance detection example using feature extraction and neural network inference."
