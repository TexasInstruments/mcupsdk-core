...
const readmeDoxygenPageTag = "EXAMPLES_AI_IMU_SENSOR_DATA_CAPTURE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "imu_sensor_data_capture_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "imu_sensor_data_capture";
    property.isInternal = false;
    property.description = "IMU sensor (BMI270 accelerometer) data capture example with DAP for Edge AI Studio integration.";
