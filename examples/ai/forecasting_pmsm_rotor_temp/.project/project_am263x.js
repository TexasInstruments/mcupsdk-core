...
const readmeDoxygenPageTag = "EXAMPLES_AI_FORECASTING_PMSM_ROTOR_TEMP";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "forecasting_pmsm_rotor_temp_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "forecasting_pmsm_rotor_temp";
    property.isInternal = false;
    property.description = "AI PMSM rotor temperature forecasting example using feature extraction and neural network inference."
