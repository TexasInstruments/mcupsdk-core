...
const files = {
    common: [
        "generic_timeseries_forecasting.c",
        "test_vector.c",
        "main.c",
        "feature_extract.c",
...
const readmeDoxygenPageTag = "EXAMPLES_AI_GENERIC_TIMESERIES_FORECASTING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "generic_timeseries_forecasting_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "generic_timeseries_forecasting";
    property.isInternal = false;
    property.description = "AI generic timeseries forecasting example using feature extraction and neural network inference."
