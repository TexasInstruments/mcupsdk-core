...
const libs_nortos_r5f = {
    common: [
        ...
        "ai.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_AI_TEMP_SENSOR_DATA_CAPTURE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "temp_sensor_data_capture_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "temp_sensor_data_capture";
    property.isInternal = false;
    property.description = "Temperature sensor data capture example with DAP for Edge AI Studio integration."
