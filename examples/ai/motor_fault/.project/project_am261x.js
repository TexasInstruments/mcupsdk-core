...
const readmeDoxygenPageTag = "EXAMPLES_AI_MOTOR_FAULT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "motor_fault_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "motor_fault";
    property.isInternal = false;
    property.description = "AI motor fault detection example using feature extraction and neural network inference."
