...
const readmeDoxygenPageTag = "EXAMPLES_AI_ARC_FAULT";
...
function getComponentProperty(device) {
    ...
    property.name = "arc_fault";
    property.isInternal = false;
    property.description = "AI arc fault detection example using feature extraction and neural network inference."
