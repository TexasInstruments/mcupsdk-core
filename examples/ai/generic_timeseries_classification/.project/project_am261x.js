...
const files = {
    common: [
        "generic_timeseries_classification.c",
        "test_vector.c",
        "main.c",
        "feature_extract.c",
...
const readmeDoxygenPageTag = "EXAMPLES_AI_GENERIC_TIMESERIES_CLASSIFICATION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "generic_timeseries_classification_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "generic_timeseries_classification";
    property.isInternal = false;
    property.description = "AI generic timeseries classification example using feature extraction and neural network inference."
