...
const readmeDoxygenPageTag = "EXAMPLES_AI_FAN_BLADE_ANOMALYDETECTION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "fan_blade_anomalydetection_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "fan_blade_anomalydetection";
    property.isInternal = false;
    property.description = "AI fan blade anomaly detection example using feature extraction and neural network inference."
