...
const files = {
    common: [
        "generic_timeseries_anomalydetection.c",
        "test_vector.c",
        "main.c",
        "feature_extract.c",
...
const readmeDoxygenPageTag = "EXAMPLES_AI_GENERIC_TIMESERIES_ANOMALYDETECTION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "generic_timeseries_anomalydetection_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "generic_timeseries_anomalydetection";
    property.isInternal = false;
    property.description = "AI generic timeseries anomaly detection example using feature extraction and neural network inference."
