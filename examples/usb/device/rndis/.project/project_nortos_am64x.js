...
const includes_nortos_r5f = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/usb/tinyusb/config/nortos/am64x_am243x/rndis_config",
		...
		"${MCU_PLUS_SDK_PATH}/source/networking/lwip/lwip-config/am64x/usb/",
...
const buildOptionCombos = [
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am64x-evm", os: "nortos",isPartOfSystemProject: false},
];
...
function getComponentProperty() {
    ...
    property.name = "rndis_nortos";
    property.isInternal = false;
    property.description = "A USB Device RNDIS example"
