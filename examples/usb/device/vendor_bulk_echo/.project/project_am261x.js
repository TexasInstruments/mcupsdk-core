...
const libs_nortos_r5f = {
    common: [
        ...
        "usbd_tusb_vendor_nortos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "usbd_tusb_vendor_freertos.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_USB_VENDOR_ECHO";
    ...
    [
        {
            ...
            output: "../main.c",
            options: {
                entryFunction: "vendor_echo_main",
            },
        }
    ];
...
function getComponentProperty() {
    ...
    property.name = "vendor_bulk_echo";
    property.isInternal = false;
    property.description = "A USB Device Vendor Bulk echo example"
