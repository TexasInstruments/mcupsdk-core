...
const readmeDoxygenPageTag = "EXAMPLES_KERNEL_DPL_LOW_LATENCY_INTERRUPT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dpl_low_latency_interrupt_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "dpl_low_latency_interrupt";
    property.isInternal = false;
    property.description = "Low latency interrupt example"
