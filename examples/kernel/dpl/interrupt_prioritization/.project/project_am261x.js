...
const readmeDoxygenPageTag = "EXAMPLES_KERNEL_DPL_INTERRUPT_PRIORITIZATION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "interrupt_prioritization",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "interrupt_prioritization";
    property.isInternal = false;
    property.description = "An interrupt prioritization example. This example demonstrates prioritization of interrupts."
