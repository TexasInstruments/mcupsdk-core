...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CBUFF_SW_TRIGGER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "cbuff_sw_trigger",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "cbuff_sw_trigger";
    property.isInternal = false;
    property.description = "An CBUFF software trigger example. This example demonstrates LVDS streaming using CBUFF SW trigger."
