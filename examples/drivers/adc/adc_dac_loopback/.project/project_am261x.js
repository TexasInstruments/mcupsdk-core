...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_DAC_LOOPBACK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_dac_loopback_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_dac_loopback";
    property.isInternal = false;
    property.description = "Demonstrates ADC DAC Loopback feature"
