...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_BURST_MODE_OVERSAMPLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_burst_mode_oversampling_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_burst_mode_oversampling";
    property.isInternal = false;
    property.description = "ADC burst mode oversampling example"
