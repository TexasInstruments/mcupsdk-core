...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_CONTINUOUS_DMA";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_continuous_dma_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_continuous_dma";
    property.isInternal = false;
    property.description = "An ADC Software triggered example. This example converts a SOC when triggered by Software."
