...
const files = {
    common: [
        "adc_trigger_repeater_undersampling.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_TRIGGER_REPEATER_UNDERSAMPLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_trigger_repeater_undersampling_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_trigger_repeater_undersampling";
    property.isInternal = false;
    property.description = "ADC Trigger Repeater Undersampling example"
