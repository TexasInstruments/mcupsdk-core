...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_PPB_EPWM_TRIP";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_ppb_epwm_trip_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_ppb_epwm_trip";
    property.isInternal = false;
    property.description = "An ADC example that triggers ePWM using ADC Post Processing Block."
