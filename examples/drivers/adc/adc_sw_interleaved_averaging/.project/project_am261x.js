...
const files = {
    common: [
        "adc_sw_interleaved_averaging.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOFTWARE_INTERLEAVED_AVERAGING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_sw_interleaved_averaging_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_sw_interleaved_averaging";
    property.isInternal = false;
    property.description = "ADC Software Interleaved Averaging example"
