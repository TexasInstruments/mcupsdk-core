...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_OPEN_SHORTS_DETECTION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_open_shorts_detection_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_open_shorts_detection";
    property.isInternal = false;
    property.description = "Example to showcase Open Shorts Detection in the ADC Channels."
