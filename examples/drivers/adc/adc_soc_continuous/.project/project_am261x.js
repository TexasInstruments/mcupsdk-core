...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_CONTINUOUS";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_continuous_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_continuous";
    property.isInternal = false;
    property.description = "ADC SOC Continuous example"
