...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_PPB_DELAY";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_ppb_delay_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_ppb_delay";
    property.isInternal = false;
    property.description = "ADC PPB Delay example"
