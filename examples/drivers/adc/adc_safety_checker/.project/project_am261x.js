...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SAFETY_CHECKER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_safety_checker_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_safety_checker";
    property.isInternal = false;
    property.description = "ADC Safety Checker example"
