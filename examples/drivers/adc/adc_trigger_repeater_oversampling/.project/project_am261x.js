...
const files = {
    common: [
        "adc_trigger_repeater_oversampling.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_TRIGGER_REPEATER_OVERSAMPLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_trigger_repeater_oversampling_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_trigger_repeater_oversampling";
    property.isInternal = false;
    property.description = "ADC Trigger Repeater Oversampling example"
