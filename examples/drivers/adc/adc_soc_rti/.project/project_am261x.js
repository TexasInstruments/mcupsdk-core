...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_RTI";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_rti_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_rti";
    property.isInternal = false;
    property.description = "ADC SOC triggered from RTI example"
