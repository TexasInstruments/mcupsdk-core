...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_OVERSAMPLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_oversampling_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_oversampling";
    property.isInternal = false;
    property.description = "ADC SOC Oversampling example"
