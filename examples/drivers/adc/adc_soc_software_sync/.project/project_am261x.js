...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_SOFTWARE_SYNC";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_software_sync_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_software_sync";
    property.isInternal = false;
    property.description = "An ADC Synchronous Software triggered example."
