...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_GLOBAL_FORCE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_global_force_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_global_force";
    property.isInternal = false;
    property.description = "Multiple ADC SOC triggered from Global Software Force"
