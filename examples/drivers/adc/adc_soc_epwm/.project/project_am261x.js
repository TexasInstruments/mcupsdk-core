...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_EPWM";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_epwm_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_epwm";
    property.isInternal = false;
    property.description = "ADC SOC Epwm example"
