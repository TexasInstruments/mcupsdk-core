...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_DIFFERENTIAL_MODE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_differential_mode_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_differential_mode";
    property.isInternal = false;
    property.description = "ADC differential mode example"
