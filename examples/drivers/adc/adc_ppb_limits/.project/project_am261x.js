...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_PPB_LIMITS";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_ppb_limits_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_ppb_limits";
    property.isInternal = false;
    property.description = "ADC PPB Limits example"
