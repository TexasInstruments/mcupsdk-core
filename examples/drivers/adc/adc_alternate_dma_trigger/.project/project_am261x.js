...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_ALTERNATE_DMA_TRIGGER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_alternate_dma_trigger_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_alternate_dma_trigger";
    property.isInternal = false;
    property.description = "ADC triggering DMA via tDMA showcasing example"
