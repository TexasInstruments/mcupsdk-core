...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SOC_ECAP";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_soc_ecap_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_soc_ecap";
    property.isInternal = false;
    property.description = "ADC SOC triggered from ECAP example"
