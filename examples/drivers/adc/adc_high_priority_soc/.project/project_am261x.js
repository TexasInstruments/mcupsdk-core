...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_HIGH_PRIORITY_SOC";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_high_priority_soc_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_high_priority_soc";
    property.isInternal = false;
    property.description = "An ADC High Priority example. This example showcases the high priority soc feature of ADC."
