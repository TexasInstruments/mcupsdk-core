...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_BURST_MODE_EPWM";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_burst_mode_epwm_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_burst_mode_epwm";
    property.isInternal = false;
    property.description = "ADC burst mode epwm example"
