...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_INTERNAL_LOOPBACK_INTERRUPT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_loopback_interrupt_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_loopback_interrupt";
