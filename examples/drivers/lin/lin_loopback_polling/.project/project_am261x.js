...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_LIN_INTERNAL_LOOPBACK_POLLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "lin_loopback_polling_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "lin_loopback_polling";
