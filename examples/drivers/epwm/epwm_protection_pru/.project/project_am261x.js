...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_PROTECTION_PRU";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_protection_pru_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_protection_pru";
    property.isInternal = false;
    property.description = "A EPWM example for PWM protection circuitry (using PRU) & ASC shutdown delay time."
