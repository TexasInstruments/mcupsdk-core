...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_DMA";
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_dma";
    property.isInternal = false;
    property.description = "An EPWM DMA test example. This example generates waveforms according to the values updated by DMA channels in EPWM registers."
