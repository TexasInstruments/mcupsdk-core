...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_CONFIGURE_SIGNAL";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_configure_signal_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_configure_signal";
    property.isInternal = false;
    property.description = "This Example Demonstrates the Configure Signal API usage."
