...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_HR_DUTY_CYCLE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_hr_duty_cycle_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_hr_duty_cycle";
    property.isInternal = false;
    property.description = "An EPWM HR duty test example. This example generates a 1KHz wave with 25% duty cycle."
