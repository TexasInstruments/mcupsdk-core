...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_DEADBAND";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_deadband_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_deadband";
    property.isInternal = false;
    property.description = "This example demonstrates the deadband functionalities of epwm."
