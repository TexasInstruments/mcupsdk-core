...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_DCCAP";
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_dccap";
    property.isInternal = false;
    property.description = "This example demonstrates the dccap functionalities of epwm."
