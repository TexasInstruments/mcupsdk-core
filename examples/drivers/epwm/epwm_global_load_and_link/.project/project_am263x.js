...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_GLOBAL_LOAD_AND_LINK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_global_load_and_link_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_global_load_and_link";
    property.isInternal = false;
    property.description = "This Example Demonstrates the Global Load Functionalities of EPWM."
