...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_TRIP_ZONE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_trip_zone_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_trip_zone";
    property.isInternal = false;
    property.description = "An EPWM Trip zone test example. This example demonstrates tripping of epwm output using OST and CBC mode."
