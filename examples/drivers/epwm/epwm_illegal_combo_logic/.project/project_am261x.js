...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_ILLEGAL_COMBO_LOGIC";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_illegal_combo_logic_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_illegal_combo_logic";
