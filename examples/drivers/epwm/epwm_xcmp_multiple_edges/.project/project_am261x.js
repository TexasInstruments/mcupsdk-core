...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_XCMP_MULTIPLE_EDGES";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_xcmp_multiple_edges_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_xcmp_multiple_edges";
    property.isInternal = false;
    property.description = "An EPWM xcmp example. This example is used to generate multiple edges in pwm cycle"
