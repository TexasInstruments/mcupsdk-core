...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_CHOPPER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_chopper_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_chopper";
    property.isInternal = false;
    property.description = "This Example Demonstrates the Chopper Submodule Functionalities of EPWM."
