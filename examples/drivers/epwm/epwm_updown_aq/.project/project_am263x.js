...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EPWM_UPDOWN_AQ";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "epwm_updown_aq_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "epwm_updown_aq";
    property.isInternal = false;
    property.description = "This Example Demonstrates the action qualifier module using UPDOWN Count mode."
