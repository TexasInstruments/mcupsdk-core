...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_RTI_LED_BLINK";
...
function getComponentProperty() {
    ...
    property.name = "rti_led_blink";
    property.isInternal = false;
    property.description = "An example to demonstrate LED blink using RTI."
