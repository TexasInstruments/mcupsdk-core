...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_QSPI_FLASH_DMA_TRANSFER";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "qspi_flash_dma_transfer",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "qspi_flash_dma_transfer";
    property.isInternal = false;
    property.description = "A QSPI Flash transfer example. This example demonstrates transfer using QSPI."
