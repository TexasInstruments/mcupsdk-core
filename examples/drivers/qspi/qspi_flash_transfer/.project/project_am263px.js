...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_QSPI_FLASH_TRANSFER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "qspi_flash_transfer",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "qspi_flash_transfer";
