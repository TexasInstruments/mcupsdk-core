...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_QSPI_FLASH_INTERRUPT_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "qspi_flash_interrupt_lld",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "qspi_flash_interrupt_lld";
    property.isInternal = false;
    property.description = "A QSPI Flash diag interrupt lld example. This example demonstrates diag using QSPI."
