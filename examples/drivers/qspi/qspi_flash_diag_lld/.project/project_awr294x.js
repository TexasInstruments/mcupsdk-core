...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_QSPI_FLASH_DIAG_LLD";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "qspi_flash_diag_lld",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "qspi_flash_diag_lld";
    property.isInternal = false;
    property.description = "A QSPI Flash diag lld example. This example demonstrates diag using QSPI."
