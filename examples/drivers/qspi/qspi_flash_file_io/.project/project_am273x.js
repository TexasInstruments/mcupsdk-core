...
const libs_nortos_r5f = {
    common: [
        ...
        "littlefs.am273x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_QSPI_FLASH_FILE_IO";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "qspi_flash_file_io_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "qspi_flash_file_io";
