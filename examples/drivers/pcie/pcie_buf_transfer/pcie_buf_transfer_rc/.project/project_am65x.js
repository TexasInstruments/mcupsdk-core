...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_PCIE_BUF_TRANSFER_RC";
...
const templates_freertos_r5f =
    [
        ...
        },
        {
            ...
            output: "../main.c",
            options: {
                entryFunction: "pcie_buf_transfer_rc_main",
            },
        }
    ];
...
function getComponentProperty() {
    ...
    property.name = "pcie_buf_transfer_rc";
