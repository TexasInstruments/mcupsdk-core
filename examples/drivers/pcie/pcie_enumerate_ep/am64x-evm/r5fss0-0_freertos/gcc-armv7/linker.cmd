...
MEMORY
{
    ...
    /* memory segment to hold our BAR0 memory ("control registers" and "data buffer" */
    BAR0_MEM : ORIGIN = 0x70060000 , LENGTH = 0x8000
	...
	/*
     * Memory section to hold our BAR1 and BAR2 test data buffer.
     * Both buffer shall be placed in DDR16SS0_DRAM
     */
    BAR1_DATA : ORIGIN = 0x080000000 , LENGTH = 0x40000000
    BAR2_DATA : ORIGIN = 0x0C0000000 , LENGTH = 0x40000000
}
...
SECTIONS
{
    ...
    .bar0_mem : ALIGN (8) {} > BAR0_MEM
    .bar1_data   : ALIGN (8) {} > BAR1_DATA
    .bar2_data  : ALIGN (8) {} > BAR2_DATA
