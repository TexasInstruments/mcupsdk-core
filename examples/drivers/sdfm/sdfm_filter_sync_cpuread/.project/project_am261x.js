...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_SDFM_FILTER_SYNC_CPUREAD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "sdfm_filter_sync_cpuread",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "sdfm_filter_sync_cpuread";
