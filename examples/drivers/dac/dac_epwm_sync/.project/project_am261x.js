...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_EPWM_SYNC";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_epwm_sync_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_epwm_sync";
    property.isInternal = false;
    property.description = "An DAC example that is synced by EPWM."
