...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_CONSTANT_VOLTAGE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_constant_voltage_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_constant_voltage";
    property.isInternal = false;
    property.description = "An DAC example that generates a constant voltage on DAC output."
