...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_RANDOM_VOLTAGE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_random_voltage_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_random_voltage";
    property.isInternal = false;
    property.description = "An DAC example that generates a random voltage on DAC output."
