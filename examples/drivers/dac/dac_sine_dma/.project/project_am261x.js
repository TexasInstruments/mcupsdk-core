...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_SINE_DMA";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_sine_dma_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_sine_dma";
    property.isInternal = false;
    property.description = "An DAC example that generates a sine wave using DMA on DAC output."
