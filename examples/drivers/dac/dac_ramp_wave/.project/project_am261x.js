...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_RAMP_WAVE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_ramp_wave_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_ramp_wave";
    property.isInternal = false;
    property.description = "An DAC example that generates a ramp wave on DAC output."
