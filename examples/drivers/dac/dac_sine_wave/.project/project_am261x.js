...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_DAC_SINE_WAVE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "dac_sine_wave_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "dac_sine_wave";
    property.isInternal = false;
    property.description = "An DAC example that generates a sine wave on DAC output."
