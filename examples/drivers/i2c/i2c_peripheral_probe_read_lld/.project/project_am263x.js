...
const files = {
    common: [
        "i2c_peripheral_probe_read_lld.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_PERIPHERAL_PROBE_READ_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "i2c_peripheral_probe_test_lld_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "i2c_peripheral_probe_read_lld";
