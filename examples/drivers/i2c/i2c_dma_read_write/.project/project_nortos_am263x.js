...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_DMA_READ_WRITE"
...
function getComponentProperty() {
    ...
    property.name = "i2c_dma_read_write";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "An i2c_dma_read_write Example. This example is intended to be a starting point for new development"
