...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_DMA_REPEAT_START";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "i2c_led_repeated_start_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "i2c_repeated_start_dma";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "An i2c_repeated_start_dma Example. This example is intended to be a starting point for new development"
