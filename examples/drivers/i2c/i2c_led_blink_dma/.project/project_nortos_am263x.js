...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_LED_BLINK_DMA";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "i2c_led_blink_dma_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "i2c_led_blink_dma";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "An i2c_led_blink_dma Example. This example is intended to be a starting point for new development"
