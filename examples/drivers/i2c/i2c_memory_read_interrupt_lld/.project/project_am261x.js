...
const files = {
    common: [
        "i2c_memory_read_interrupt_lld.c",
        "main.c",
        "board.c"
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_MEMORY_READ_INTERRUPT_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "i2c_memory_read_interrupt_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "i2c_memory_read_interrupt_lld";
