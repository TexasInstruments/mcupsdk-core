...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_TMU_CONTEXTSAVE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "tmu_context_save_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "tmu_context_save";
    property.isInternal = false;
    property.description = "This example shows the context save feature of TMU."
