...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "tmu_park_transform_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "tmu_park_transform";
    property.isInternal = false;
    property.description = "This example shows the gains of using TMU and how it enhances the performance in application use case"
