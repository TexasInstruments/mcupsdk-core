...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CSIRX_INTERNAL_CAPTURE";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "csirx_internal_capture_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "csirx_internal_capture";
    property.isInternal = false;
    property.skipProjectSpec = false;
    property.buildOptionCombos = buildOptionCombos;
    property.description = "This example shows how to use CSIRX capture using the internal test mode in CSIRX HW.";
