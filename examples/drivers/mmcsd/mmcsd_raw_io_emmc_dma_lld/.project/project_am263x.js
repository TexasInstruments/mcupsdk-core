...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC_DMA_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mmcsd_raw_io_emmc_dma_lld_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mmcsd_raw_io_emmc_dma_lld";
