...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_HWA_REAL_FFT";
...
function getComponentProperty() {
    ...
    property.name = "hwa_real_fft";
    property.isInternal = false;
    property.description = "HWA based FFT example. This example demonstrates HWA FFT operation for real input data"
