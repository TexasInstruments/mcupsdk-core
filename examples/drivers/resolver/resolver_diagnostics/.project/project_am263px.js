...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_RESOLVER_DIAGNOSITCS";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "resolver_diagnostics_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "resolver_diagnostics";
    property.isInternal = false;
    property.description = "Example to show case the HW Resolver Diagnostics"
