...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MIBSPI_LOOPBACK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mibspi_loopback_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "mibspi_loopback";
    property.isInternal = false;
    property.description = "This example verifies MIBSPI loopback mode of operation"
