...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MIBSPI_LOOPBACK_DMA";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mibspi_loopback_dma",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "mibspi_loopback_dma";
    property.isInternal = false;
    property.description = "This example verifies MIBSPI loopback DMA mode of operation"
