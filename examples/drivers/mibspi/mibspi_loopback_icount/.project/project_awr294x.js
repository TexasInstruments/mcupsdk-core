...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MIBSPI_LOOPBACK_ICOUNT";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mibspi_loopback_icount_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "mibspi_loopback_icount";
    property.isInternal = false;
    property.description = "This example verifies MIBSPI loopback mode of operation in multi icount mode"
