...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EDMA_CHAIN_TRANSFER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "edma_chain_transfer",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "edma_chain_transfer";
    property.isInternal = false;
    property.description = "An EDMA chain transfer example. This example demonstrates chain in EDMA."
