...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EDMA_POLLED_TRANSFER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "edma_polled_transfer",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "edma_polled_transfer";
    property.isInternal = false;
    property.description = "An EDMA Polled transfer example. This example demonstrates polling in EDMA."
