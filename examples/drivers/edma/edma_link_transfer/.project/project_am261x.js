...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EDMA_LINK_TRANSFER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "edma_link_transfer",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "edma_link_transfer";
    property.isInternal = false;
    property.description = "An EDMA link transfer example. This example demonstrates linking in EDMA."
