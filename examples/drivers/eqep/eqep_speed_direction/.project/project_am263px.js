...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EQEP_SPEED_DIRECTION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "eqep_speed_direction_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "eqep_speed_direction";
    property.isInternal = false;
    property.description = "An EQEP Speed direction example. This example provides speed measurement and direction using unit time out."
