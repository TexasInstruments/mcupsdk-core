...
const files_freertos_rf5 = {
    common: [
        "mcspi_external_loopback_peripheral.c",
        "main.c",
    ],
};
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcspi_controller_transfer_main",
        },
    }
];
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcspi_peripheral_transfer_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mcspi_external_loopback";
