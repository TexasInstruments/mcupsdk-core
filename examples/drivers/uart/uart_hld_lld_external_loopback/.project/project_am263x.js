...
const files = {
    common: [
        "uart_hld_lld_external_loopback.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_UART_HLD_LLD_EXTERNAL_LOOPBACK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "uart_hld_lld_external_loopback",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "uart_hld_lld_external_loopback";
    property.isInternal = false;
    property.description = "A UART echo example. This example demonstrates uart hld-lld integrated APIs using UART."
