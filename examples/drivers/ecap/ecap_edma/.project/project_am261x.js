...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ECAP_EDMA";
...
function getComponentProperty(device) {
    ...
    property.name = "ecap_edma";
    property.isInternal = false;
    property.description = "An ECAP triggering EDMA example. This example demonstrates EDMA triggering from ECAP."
