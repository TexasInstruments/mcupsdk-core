...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_FSI_HLD_LOOPBACK_POLLING";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "fsi_hld_loopback_polling_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "fsi_hld_loopback_polling";
