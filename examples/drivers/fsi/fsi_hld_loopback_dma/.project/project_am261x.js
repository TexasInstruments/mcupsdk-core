...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_FSI_HLD_LOOPBACK_DMA";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "fsi_hld_loopback_dma_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "fsi_hld_loopback_dma";
