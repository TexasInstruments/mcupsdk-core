...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_FSI_LOOPBACK_INTERRUPT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "fsi_loopback_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "fsi_loopback_interrupt";
