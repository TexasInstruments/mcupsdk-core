...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_FSI_HLD_LOOPBACK_INTERRUPT";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "fsi_hld_loopback_interrupt_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "fsi_hld_loopback_interrupt";
