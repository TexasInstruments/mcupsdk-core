...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCAN_CANFD_EXTERNAL_READ_WRITE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "canfd_external_read_write_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "canfd_external_read_write";
