...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CMPSS_CALIBRATION";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "cmpss_calibration",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "cmpss_calibration";
    property.isInternal = false;
    property.description = "A CMPSS example that shows the calibration of CMPSS when the negative input of the comparator is driven from the compdac"
