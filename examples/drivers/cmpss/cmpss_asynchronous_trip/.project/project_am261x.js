...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "cmpss_asynchronous_trip",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "cmpss_asynchronous_trip";
    property.isInternal = false;
    property.description = "A CMPSS example that enables the CMPSS High comparator and feeds the asynchronous output to GPIO and EPWM"
