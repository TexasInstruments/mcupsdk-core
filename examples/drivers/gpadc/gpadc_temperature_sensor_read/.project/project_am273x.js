...
const files = {
    common: [
        "gpadc_temperature_sensor_read.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_GPADC_TEMPERATURE_SENSOR_READ";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "gpadc_temperature_sensor_read_main",
            },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "gpadc_temperature_sensor_read";
