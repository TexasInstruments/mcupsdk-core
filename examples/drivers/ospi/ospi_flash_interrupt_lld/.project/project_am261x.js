...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_OSPI_FLASH_INTERRUPT_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ospi_flash_interrupt_lld",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "ospi_flash_interrupt_lld";
