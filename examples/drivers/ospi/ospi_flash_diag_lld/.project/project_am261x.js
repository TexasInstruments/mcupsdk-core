...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_OSPI_FLASH_DIAG_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ospi_flash_diag_lld",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "ospi_flash_diag_lld";
