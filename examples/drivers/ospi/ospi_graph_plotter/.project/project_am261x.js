...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_OSPI_GRAPH_PLOTTER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "ospi_graph_plotter_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "ospi_graph_plotter";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "An Ospi Graph Plotter Example. This example is used to plot the OSPI PHY sweep data in a graph";
