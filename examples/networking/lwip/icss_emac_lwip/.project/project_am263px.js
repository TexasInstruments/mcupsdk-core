...
const libdirs_freertos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/lib",
        "${MCU_PLUS_SDK_PATH}/source/networking/lwip/lib",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/lwipif/lib",
...
const includes_freertos_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/lwipif/inc",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/source",
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/firmware",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/firmware/icss_dual_emac",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/firmware/source",
        "${MCU_PLUS_SDK_PATH}/source/networking/icss_emac_lld/icss_emac/firmware/icss_switch",
    ],
};
