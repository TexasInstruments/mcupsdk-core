...
const libdirs_freertos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/motor_control/position_sense/tamagawa/lib",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "motorcontrol_tamagawa.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "tamagawa_diagnostic_single_channel";
