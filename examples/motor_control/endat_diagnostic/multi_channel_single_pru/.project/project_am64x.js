...
const libdirs_freertos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/motor_control/position_sense/endat/lib",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "motorcontrol_endat.am64x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLE_MOTORCONTROL_ENDAT";
...
function getComponentProperty() {
    ...
    property.name = "endat_diagnostic_multi_channel_single_pru";
