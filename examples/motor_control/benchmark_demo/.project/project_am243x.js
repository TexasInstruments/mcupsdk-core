...
const includes_nortos_r5fss0_0 = {
    common: [
        "${MCU_PLUS_SDK_PATH}/examples/motor_control/benchmark_demo/common",
...
const includes_nortos_r5fss1_1 = {
    common: [
        "${MCU_PLUS_SDK_PATH}/examples/motor_control/benchmark_demo/cmsis_foc/control_suite/math_blocks",
        "${MCU_PLUS_SDK_PATH}/examples/motor_control/benchmark_demo/common",
        "${MCU_PLUS_SDK_PATH}/source/cmsis/DSP/Include",
        "${MCU_PLUS_SDK_PATH}/source/cmsis/Core/Include",
    ],
...
const readmeDoxygenPageTag = "EXAMPLE_MOTORCONTROL_BENCHMARKDEMO";
