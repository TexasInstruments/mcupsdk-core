...
const hexBuildOptions = [
    ...
    "-o=sent_decoder_using_iep_capture_enhanced_serial_msg_pru0_bin.h",
];
...
let postBuildSteps = [
    "$(CCS_INSTALL_DIR)/utils/cygwin/mv sent_decoder_using_iep_capture_enhanced_serial_msg_pru0_bin.h ${MCU_PLUS_SDK_PATH}/examples/pru_io/sent/decoder_pruicss_iep_ecap/example/firmware/sent_decoder_using_iep_capture_enhanced_serial_msg_pru0_bin.h;"
];
