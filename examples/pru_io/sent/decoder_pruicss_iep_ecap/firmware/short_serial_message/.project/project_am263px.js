...
{
    return  [
        "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=SentDecoderFirmwarePru -o sent_decoder_using_iep_capture_short_serial_msg_pru0_bin.h sent_decoder_using_iep_capture_short_serial_msg_" + board + "_" + cpu + "_fw_ti-pru-cgt.out; $(SED) -i '0r ${MCU_PLUS_SDK_PATH}/source/pru_io/firmware/pru_load_bin_copyright.h' sent_decoder_using_iep_capture_short_serial_msg_pru0_bin.h ; $(MOVE) sent_decoder_using_iep_capture_short_serial_msg_pru0_bin.h ${MCU_PLUS_SDK_PATH}/examples/pru_io/sent/decoder_pruicss_iep_ecap/firmware/short_serial_message/am263px-cc/sent_decoder_using_iep_capture_short_serial_msg_pru0_bin.h"
    ];
}
...
function getComponentProperty() {
    ...
    property.name = "sent_decoder_using_iep_capture_short_serial_msg",
    property.isInternal = false;
    property.description = "PRU0 Firmware for Sent Decoder Using ECAP (Short serial message support)"
