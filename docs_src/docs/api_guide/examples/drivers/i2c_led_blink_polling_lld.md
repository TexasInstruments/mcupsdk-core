# I2C Led Blink Polling LLD {#EXAMPLES_DRIVERS_I2C_LED_BLINK_POLLING_LLD}
...
It makes use of the I2C LLD Driver and it's polling transfer API.

The application will blink all the I2C controlled LED in the EVM.

Application exits after 10 iterations.

# Supported Combinations {#EXAMPLES_DRIVERS_I2C_LED_BLINK_POLLING_LLD_COMBOS}
...
\code
[I2C] LLD LED Blink Test Started in Polling Mode ...
