# MCSPI Loopback DMA LLD {#EXAMPLES_DRIVERS_MCSPI_LOOPBACK_DMA_LLD}
...
in blocking, DMA mode of operation from LLD driver.
...
# Supported Combinations {#EXAMPLES_DRIVERS_MCSPI_LOOPBACK_DMA_LLD_COMBOS}
...
\cond SOC_AM64X
 ...
 Example folder | examples/drivers/mcspi/mcspi_loopback_dma_lld
