# PCIE MSI IRQ EP {#EXAMPLES_DRIVERS_PCIE_MSI_IRQ_EP}

[TOC]

# Introduction

The PCIe MSI IRQ (EP) example demonstrates MSI (Message Signalled Interrupt) from EP to RC.
...
\cond SOC_AM64X || SOC_AM243X
 ...
 Example folder | examples/drivers/pcie/pcie_msi_irq/pcie_msi_irq_ep
...
- Run the \ref EXAMPLES_DRIVERS_PCIE_MSI_IRQ_RC example on the other connected board
