# MCSPI Loopback Interrupt LLD {#EXAMPLES_DRIVERS_MCSPI_LOOPBACK_INTERRUPT_LLD}
...
# Supported Combinations {#EXAMPLES_DRIVERS_MCSPI_LOOPBACK_INTERRUPT_LLD_COMBOS}
...
\cond SOC_AM64X
 ...
 Example folder | examples/drivers/mcspi/mcspi_loopback_interrupt_lld
