# OSPI Flash INTERRUPT LLD {#EXAMPLES_DRIVERS_OSPI_FLASH_INTERRUPT_LLD}
...
# Supported Combinations {#EXAMPLES_DRIVERS_OSPI_FLASH_INTERRUPT_LLD_COMBOS}
...
\cond SOC_AM64X
 ...
 Example folder | examples/drivers/ospi/ospi_flash_interrupt_lld
