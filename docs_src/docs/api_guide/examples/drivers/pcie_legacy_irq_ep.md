# PCIE legacy IRQ EP {#EXAMPLES_DRIVERS_PCIE_LEGACY_IRQ_EP}

[TOC]

# Introduction

The PCIe legacy IRQ (EP) example demonstrates legacy interrupts from and EP to RC device.

The EP device sends back the buffer received from the RC device and sends a legacy IRQ to the RC device.
...
\cond SOC_AM64X || SOC_AM243X
 ...
 Example folder | examples/drivers/pcie/pcie_legacy_irq/pcie_legacy_irq_ep
...
- Run the \ref EXAMPLES_DRIVERS_PCIE_LEGACY_IRQ_RC example on the other connected board
