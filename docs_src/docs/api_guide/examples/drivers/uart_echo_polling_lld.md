# UART Echo Polling LLD{#EXAMPLES_DRIVERS_UART_ECHO_POLLING_LLD}

[TOC]

# Introduction

This example demonstrates the UART RX and TX operation in polling
mode of operation.
This example receives 8 characters and echos back the same.
The application ends when the user types 8 characters.

# Supported Combinations {#EXAMPLES_DRIVERS_UART_ECHO_POLLING_LLD_COMBOS}
...
\cond SOC_AM64X
 ...
 Example folder | examples/drivers/uart/uart_echo_polling_lld
