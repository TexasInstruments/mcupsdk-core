# I2C Led Blink Interrupt LLD {#EXAMPLES_DRIVERS_I2C_LED_BLINK_INTERRUPT_LLD}
...
It makes use of the I2C LLD Driver and it's interrupt transfer API.

The application will blink all the I2C controlled LED in the EVM.

Application exits after 10 iterations.

# Supported Combinations {#EXAMPLES_DRIVERS_I2C_LED_BLINK_INTERRUPT_LLD_COMBOS}
