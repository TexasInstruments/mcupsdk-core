...
\code
$make -s -C examples/security/crypto/dthe_sha/crypto_sha_256/<soc>-<board>/r5fss0-0_nortos/ti-arm-clang all DEVICE=<soc>
\endcode
...
### Run UART_bootloader
\code
python uart_bootloader.py -p <COMxx> --bootloader=sbl_prebuilt/<soc>-<board>/sbl_uart.release.hs.tiimage --file=../../examples/security/crypto/dthe_sha/crypto_sha_256/<soc>-<board>/r5fss0-0_nortos/ti-arm-clang/dthe_sha_256.release.appimage
\endcode
