# DTHE HMAC SHA 512 {#EXAMPLES_DRIVERS_DTHE_HMAC_SHA_512}
...
### Run UART_bootloader
\code
python uart_bootloader.py -p <COMxx> --bootloader=sbl_prebuilt/<soc>-<board>/sbl_uart.release.hs.tiimage --file=../../examples/security/crypto/dthe_sha/crypto_hmac_sha512/<soc>-<board>/r5fss0-0_nortos/ti-arm-clang/dthe_hmac_sha512.release.mcelf
\endcode
