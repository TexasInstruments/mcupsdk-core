...
\cond SOC_AM263X
   -# \subpage EXAMPLES_DRIVERS_I2C_PERIPHERAL_PROBE_READ_LLD
...
-# MMCSD
   ...
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_SD_LLD
\cond SOC_AM263X
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC_DMA
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC_DMA_LLD
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC_INTR_LLD
   -# \subpage EXAMPLES_DRIVERS_MMCSD_RAW_IO_EMMC_LLD
\endcond
\cond SOC_AM263X
