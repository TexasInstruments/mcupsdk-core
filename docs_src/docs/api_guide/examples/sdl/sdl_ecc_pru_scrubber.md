# SDL ECC PRU Scrubber Example {#EXAMPLES_SDL_ECC_PRU_SCRUBBER}
...
## PRU Firmware Combinations {#EXAMPLES_SDL_ECC_PRU_SCRUBBER_PRU0_COMBOS}
\cond SOC_AM263PX
...
## R5F Host Application Combinations {#EXAMPLES_SDL_ECC_PRU_SCRUBBER_R5F0_COMBOS}
\cond SOC_AM263PX
...
(\ref EXAMPLES_SDL_ECC_PRU_SCRUBBER). After building, the generated firmware
...
- After building, proceed to build and run the R5F host application
  (\ref EXAMPLES_SDL_ECC_PRU_SCRUBBER), which loads this firmware onto ICSS_M0_PRU0.
...
## When application runs with no critical ECC errors:
...
## R5F Host Application Specific Use Cases
...
## Shared DMEM Communication Interface (R5F Host Perspective)
...
### R5F Host Application Component
