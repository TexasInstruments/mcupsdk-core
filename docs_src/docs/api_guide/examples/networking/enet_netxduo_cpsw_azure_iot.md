# Enet NetxDuo CPSW Azure IOT Example{#EXAMPLES_ENET_NETXDUO_CPSW_AZURE_IOT}
...
This example illustrates the configuration and usage of the NetXDuo Azure IOT addon. 
The CPSW controller is used in switch mode.

This example does the following
- Initializes the ethernet driver for the underlying HW.
- Initializes the NetxDuo stack for TCP/UDP IP.
- Initializes NetXDuo Azure IOT addon.
- Sends telemetry messages to an Azure IOT hub.
...
# Supported Combinations
 ...
 Example folder | source/networking/enet/core/examples/netxduo/enet_netxduo_cpsw_azure_iot
...
- Follow <a href="https://learn.microsoft.com/en-us/azure/iot-hub/create-hub?tabs=portal#create-an-iot-hub">these instructions</a> to create a IoT Hub and test device from the Microsoft Azure portal.
- Set the predefined symbols in the CCS project properties as shown below. Replace the dummy values in the screenshot with the actual values taken from the IoT device connection string.
The connection string can be found in the IOT device page of your Microsoft Azure portal and has the following format: HostName=<>;DeviceId=<>;SharedAccessKey=<>. 

  \imageStyle{netxduo_azure_iot_ccs_predefined_symbols.png,width:80%}
  \image html netxduo_azure_iot_ccs_predefined_symbols.png Set the relevant predefined symbols in CCS
...
## Sample output of the NetxDuo Azure IOT client.
...
Local Interface IP is: 192.168.50.118
DNS Server address: 192.168.50.1
SNTP Time Sync...0.pool.ntp.org
IoTHub Host Name: jblo-test-hub.azure-devices.net; Device ID: testDev.
Connected to IoTHub.
...
- Received messages statistics on the Microsoft Azure portal.

  \imageStyle{netxduo_azure_iot_azure_portal.png,width:80%}
  \image html netxduo_azure_iot_azure_portal.png Received messages as seen from the Microsoft Azure portal
