# Enet Loopback Example {#EXAMPLES_ENET_LOOPBACK}
...
This example exercises the MAC loopback functionality of the hardware. The CPSW hardware is opened with default initialization parameters and the MAC loopback is enabled.
...
\cond SOC_AM273X
 ...
 Example folder | examples/networking/enet_loopback/V1
...
\cond SOC_AM64X
 ...
 Toolchain      | ti-arm-clang
 Boards         | @VAR_BOARD_NAME_LOWER
 Example folder | examples/networking/enet_loopback/V0
