...
EPWM sysconfig feature compatible to AM263                                                     | EPWM
DSP example to load DSP fully                                                                  | Examples
...
<tr>
    <td> SITREQ-6053
    <td> AM273: EPWM sysconfig to be feature compatible to AM263
    <td> EPWM
    <td> PSDK-SITARA_12.00
    <td> 
</tr>
<tr>
    <td> SITREQ-6052
    <td> AM273: DSP example to load DSP fully
    <td> Examples
    <td> PSDK-SITARA_12.00
    <td> 
</tr>
<tr>
    <td> PROC_SDL-7649
    <td> MCRC: am273: Missing functionality in SDL_MCRC_configCRCType()
    <td> MCRC
    <td> 12.01.00
    <td> 
</tr>
<tr>
    <td> SITSW-6008
    <td> Unallocated space access to DSP L2 - DSP IP is not blocking access to reserved space causing aliasing and L2 parity error (i2341)
    <td> DSP-L2
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6009
    <td> Recommended HWA memInit Sequence (i2390)
    <td> HWA
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6737
    <td> MibSPI in Peipheral Mode in 3- or 4-Pin Communication Transmits Data Incorrectly for Slow SPICLK Frequencies and for Clock Phase = 1 (i2336)
    <td> MibSPI
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6004
    <td> A Data Length Error is Generated Repeatedly in Peripheral Mode When IO Loopback is Enabled (i2337)
    <td> MibSPI
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6007
    <td> Spurious RX DMA REQ From a Peripheral Mode MibSPI (i2338)
    <td> MibSPI
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6735
    <td> MibSPI RX RAM RXEMPTY Bit Does Not Get Cleared After Reading (i2339)
    <td> MibSPI
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6003
    <td> Unaligned access from DSS CM4 could cause data integrity failure and hang (i2289)
    <td> HWA
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-7293
    <td> R5FSS: The same interrupt cannot be nested back-2-back within another interrupt (i2162)
    <td> Interrupt
    <td> 12.00.00
    <td> 
</tr>
<tr>
    <td> SITSW-6734
    <td> EDMA transfer that spans M1+M2 memories of HWA could result in data corruption (i2288)
    <td> EDMA
    <td> 12.00.00
    <td> 
</tr>
...
<tr>
    <td> i2162
    <td> R5FSS: The same interrupt cannot be nested back-2-back within another interrupt
    <td> Interrupt
    <td> Implemented
</tr>
<tr>
