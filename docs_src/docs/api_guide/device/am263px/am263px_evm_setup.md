...
- What is not included with EVM
 ...
 \note Refer to EVM page for more details, https://www.ti.com/tool/TMDSCNCD263P

### AM263PX-LP

  \imageStyle{am263px_lp_overview.png,width:50%}
  \image html am263px_lp_overview.png "@VAR_LP_BOARD_NAME"

<!-- - Major Components and Features

  \imageStyle{am263px_lp_overview1.png,width:80%}
  \image html am263px_lp_overview1.png "@VAR_LP_BOARD_NAME Components and Features" -->
...
### AM263PX-LP
  \imageStyle{am263px_lp_power_supply.png,width:50%}
  \image html am263px_lp_power_supply.png "@VAR_LP_BOARD_NAME Power "

- Bootmode selection

  \imageStyle{am263px_lp_bootswitch.png,width:20%}
  \image html am263px_lp_bootswitch.png "@VAR_LP_BOARD_NAME bootmode"
...
This mode is used to flash files to the EVM flash via UART. It can also be used to boot applications via UART.
  ...
  \imageStyle{am263px_lp_boot_pins_uart_mode.png,width:30%}
  \image html am263px_lp_boot_pins_uart_mode.png "UART BOOT MODE"
...
This mode is used in CCS.
  ...
  \image html am263px_lp_boot_pins_noboot_mode.png "NO BOOT MODE"
